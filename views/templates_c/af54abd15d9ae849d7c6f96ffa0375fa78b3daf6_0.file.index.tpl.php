<?php
/* Smarty version 3.1.34-dev-7, created on 2020-02-11 13:56:39
  from 'C:\xampp\htdocs\rto_fm\views\template\template_front\exa\index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5e42a4873d5a10_29055330',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'af54abd15d9ae849d7c6f96ffa0375fa78b3daf6' => 
    array (
      0 => 'C:\\xampp\\htdocs\\rto_fm\\views\\template\\template_front\\exa\\index.tpl',
      1 => 1581425744,
      2 => 'file',
    ),
  ),
...
function content_5e42a4873d5a10_29055330 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en-US">
  <head>
    <meta charset="UTF-8">
...
>
    <?php echo '<script'; ?>
 type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['theme_path']->value;?>
/js/jquery.events.touch.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['theme_path']->value;?>
        ...
        <nav class="background-transparent background-transparent-hightlight full-width sticky">
          <div class="s-12 l-2">
            <a href="index.html" class="logo">
              ...
              <img class="logo-before" src="<?php echo $_smarty_tpl->tpl_vars['rootdir']->value;?>
/views/assets/aplikasi/<?php echo $_smarty_tpl->tpl_vars['dataaplikasi']->value['gambar'];?>
" alt="">
              <!-- Logo version after sticky nav -->
              <img class="logo-after" src="<?php echo $_smarty_tpl->tpl_vars['rootdir']->value;?>
/views/assets/aplikasi/<?php echo $_smarty_tpl->tpl_vars['dataaplikasi']->value['gambar'];?>
" alt="">
            </a>
          </div>
            ...
            <div class="margin">
              ...
              <div class="s-12 m-12 l-4 margin-m-bottom-30">
                ...
                <p class="text-size-14">
                   <?php echo $_smarty_tpl->tpl_vars['dataaplikasi']->value['alamat'];?>
              ...
              <div class="s-12 m-12 l-4 margin-m-bottom-30">
                ...
                <p class="text-size-14">
                   <?php echo $_smarty_tpl->tpl_vars['dataaplikasi']->value['email'];?>
              ...
              <div class="s-12 m-12 l-4 ">
                ...
                <p class="text-size-14">
                   <?php echo $_smarty_tpl->tpl_vars['dataaplikasi']->value['telp'];?>
