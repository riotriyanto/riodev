  ...
  <body class="size-1140">
          ...
          <div class="s-12 m-6 l-6">
            <div class="right">
              <ul class="top-bar-social right">
                <li><a href="{$basedir}"><i class="icon-facebook_circle text-orange-hover"></i></a></li>
                <li><a href="{$basedir}"><i class="icon-twitter_circle text-orange-hover"></i></a> </li>
                <li><a href="{$basedir}"><i class="icon-google_plus_circle text-orange-hover"></i></a></li>
                <li><a href="{$basedir}"><i class="icon-instagram_circle text-orange-hover"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="line">
          ...
          <div class="top-nav s-12 l-10">
            ...
            <!-- <ul class="right chevron">
              ...
              <li><a href="{$basedir}">Products</a></li>
              <li><a>Services</a>
                <ul>
                  <li><a>Service 1</a>
                    <ul>
              ...
              <li><a href="{$basedir}">About</a></li>
              <li><a href="{$basedir}">Gallery</a></li>
              <li><a href="{$basedir}">Contact</a></li>
            </ul> -->
          </div>
        </div>
      </nav>
      ...
      <section class="section background-dark">
        <div class="line">
          <div class="carousel-fade-transition owl-carousel carousel-main carousel-nav-white carousel-wide-arrows">
            ...
            <div class="item">
              <div class="s-12 center">
                <img src="{$theme_path}/img/02-boxed.jpg" alt="">
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
        ...
        <div class="line">
          <div class="margin">
            <div class="s-12 m-12 l-4 margin-m-bottom">
              <img class="margin-bottom" src="{$theme_path}/img/img-01.jpg" alt="">
              <h2 class="text-thin">Clean Design</h2>
              <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</p> 
              <a class="text-more-info text-primary-hover" href="{$basedir}">Read more</a>                
            </div>
            <div class="s-12 m-12 l-4 margin-m-bottom">
              <img class="margin-bottom" src="{$theme_path}/img/img-02.jpg" alt="">
              <h2 class="text-thin">Valid code</h2>
              <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</p> 
              <a class="text-more-info text-primary-hover" href="{$basedir}">Read more</a>                
            </div>
            <div class="s-12 m-12 l-4 margin-m-bottom">
              <img class="margin-bottom" src="{$theme_path}/img/img-03.jpg" alt="">
    ...
    <footer>
      ...
      <div class="background-primary padding text-center">
        <a href="{$basedir}"><i class="icon-facebook_circle icon2x text-white"></i></a> 
        <a href="{$basedir}"><i class="icon-twitter_circle icon2x text-white"></i></a>
        <a href="{$basedir}"><i class="icon-google_plus_circle icon2x text-white"></i></a>
        <a href="{$basedir}"><i class="icon-instagram_circle icon2x text-white"></i></a>                                                                        
      </div>
          ...
          <div class="margin">
            ...
            <div class="s-12 m-12 l-4 margin-m-bottom-2x">
              ...
              <div class="line">
                ...
                <div class="s-11 m-11 l-11 margin-bottom-10">
                  <p><a href="{$basedir}" class="text-primary-hover"><b>E-mail:</b> contact@sampledomain.com</a></p>
                </div>
              </div>
              <div class="line">
                <div class="s-1 m-1 l-1 text-center">
              ...
              <div class="line">
                ...
                <div class="s-11 m-11 l-11 margin-bottom-10">
                  <p><a href="{$basedir}" class="text-primary-hover"><b>Twitter</b></a></p>
                </div>
              </div>
              <div class="line">
                <div class="s-1 m-1 l-1 text-center">
                ...
                <div class="s-11 m-11 l-11">
                  <p><a href="{$basedir}" class="text-primary-hover"><b>Facebook</b></a></p>
                </div>
              </div>
            </div>
      ...
      <section class="padding background-dark">
        <div class="line">
          ...
          <div class="s-12 l-6">
            <a class="right text-size-12" href="{$basedir}" title="Responsee - lightweight responsive framework">Design and coding<br> by Responsee Team</a>
          </div>
        </div>
      </section>
    </footer> 
